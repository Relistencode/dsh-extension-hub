...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			"import.kindSkills": "类型: 技能",
			"import.kindMcp": "类型: MCP",
			"import.kindAll": "类型: 全部",
			"import.scan": "检索可导入项",
		...
		var en = {
			...
			"tab.skills": "Skills",
			"tab.mcp": "MCP Servers",
			"tab.import": "Import from Claude/Codex",
			...
			"import.kindSkills": "Type: Skills",
			"import.kindMcp": "Type: MCP",
			"import.kindAll": "Type: All",
		...
		var REMOTE_METHODS = ["list", "getSkill", "createSkill", "updateSkill", "removeSkill", "toggleSkill", "getMcp", "upsertMcp", "removeMcp", "toggleMcp", "discover", "importItems", "projectInfo", "getState", "setState", "pickProjectFolder", "listDirectory", "createDirectory"];
		...
		function ImportTab(props) {
			...
			var kindState = React.useState("skills");
			...
			return h("div", { className: "skm-wrap" },
				...
				h("div", { className: "skm-toolbar" },
					...
					h("select", { className: "skm-select", style: { width: "auto" }, value: kind, onChange: function (e) { setKind(e.target.value); setData(null); setResults(null); } },
						h("option", { value: "skills" }, t("import.kindSkills")),
						h("option", { value: "mcp" }, t("import.kindMcp")),
						h("option", { value: "all" }, t("import.kindAll"))),
					h("select", { className: "skm-select", style: { width: "auto" }, value: scope, onChange: function (e) { setScope(e.target.value); } },
		...
		function SkillMcpSection(props) {
			...
			return h("div", { className: "skm-wrap", style: { padding: "2px 0" } },
				h("div", { className: "skm-tabs" },
					...
					h("button", { type: "button", className: "skm-tab" + (tab === "import" ? " skm-active" : ""), onClick: function () { setTab("import"); } }, t("tab.import"))),
				...
				tab === "import" ? h(ImportTab, { t: t, scope: scope, setScope: setScope, folder: folderState.folder, saveFolder: folderState.saveFolder }) : null);
		}
