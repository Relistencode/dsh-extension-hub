...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			"features.myrules.title": "个性化 · 全局指令",
			"features.myrules.desc": "在设置页编辑此主机全局指令（~/.dsh/AGENTS.md），适用于此主机上所有会话。",
		};
		var en = {
			...
			"features.myrules.title": "Customize · Global instructions",
			"features.myrules.desc": "Edit host-wide global instructions from the settings page — applies to every session on this host.",
		};
