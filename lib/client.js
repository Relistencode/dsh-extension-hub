...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var REMOTE_METHODS = ["list", "getSkill", "createSkill", "updateSkill", "removeSkill", "toggleSkill", "getMcp", "upsertMcp", "removeMcp", "toggleMcp", "discover", "importItems", "projectInfo", "getState", "setState", "pickProjectFolder", "listDirectory", "createDirectory", "checkUpdates"];
			...
			return h("div", { className: "skm-wrap", style: { padding: "2px 0" } },
				h("div", { className: "skm-header" },
					...
					h("div", { className: "skm-header-side" },
						Btn({ sm: true, className: "skm-update-btn", disabled: updateBusy, onClick: checkUpdates }, t("update.check")))),
				updateInfo ? h(Banner, { kind: updateKind(updateInfo), text: updateText(updateInfo) }) : null,
