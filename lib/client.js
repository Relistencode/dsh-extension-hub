...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			"tab.discover": "发现插件",
			"tab.curated": "精选目录",
			"curated.hint": "社区精选插件目录（每日更新，人工维护）。想搜索全部 GitHub 插件？前往「发现插件」。",
			"curated.loading": "加载中…",
			"curated.empty": "目录为空",
		...
		var en = {
			...
			"tab.curated": "Curated",
			"curated.hint": "Community-curated plugin catalog (updated daily). Want to search every GitHub plugin? Open “Discover”.",
		...
		function SkillMcpSection(props) {
			...
			return h("div", { className: "skm-wrap", style: { padding: "2px 0" } },
				...
				h("div", { className: "skm-tabs" },
					...
					h("button", { type: "button", className: "skm-tab" + (tab === "curated" ? " skm-active" : ""), onClick: function () { setTab("curated"); } }, t("tab.curated")),
				...
				tab === "curated" ? h(CuratedTab, { t: t }) : null,
