	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"" + CSS_ID + "\"]") === null) {
			...
			tag.textContent = [
				...
				".skm-btn.skm-primary{background:var(--dsw-alias-label-primary,#1f2329);border-color:var(--dsw-alias-label-tertiary,#8f959e);color:var(--dsw-alias-bg-layer-2,#fff)}",
				...
				".skm-group-title{font-size:13px;font-weight:600;color:var(--dsw-alias-label-primary,#1f2329)}",
		...
		var zh = {
			...
			"tab.curated": "精选目录",
			"discover.more": "发现更多",
			"curated.hint": "社区精选插件目录（每日更新，人工维护）。想搜索全部 GitHub 插件？切换到「发现更多」。",
			"curated.loading": "加载中…",
			"curated.empty": "目录为空",
			...
			"features.title": "附加功能",
			"features.hint": "由 Extension Hub 提供的可选功能，安装后出现在设置页。",
			"features.loading": "加载中…",
			"features.loadFailed": "加载失败: ",
			"features.install": "安装",
			"features.installing": "安装中…",
			"features.uninstall": "卸载",
			"features.disable": "停用",
			"features.enable": "启用",
			"features.statusInstalled": "已启用",
			"features.statusDisabled": "已停用",
			"features.statusMissing": "未安装",
			"features.installDone": "已安装 {name}，重启 dsh web 后生效。",
			"features.actionDone": "已写入配置，重启 dsh web 后生效。",
			"features.opFailed": "操作失败: ",
			"features.disableConfirm": "停用「{name}」？停用后该功能将不再生效。",
			"features.uninstallWarn": "卸载「{name}」将从配置移除该功能并删除包文件。不清楚功能作用时，卸载可能带来未知问题！",
			"features.bundleUninstallHint": "「{name}」是通过官方 dsh plugin add（bundle 方式）安装的，请用 dsh plugin --profile web remove {name} 卸载，不要在这里重复安装或删除。",
			"features.confirmUninstall": "确认卸载？",
			"features.my-rules.title": "个性化 · 全局指令",
			"features.my-rules.desc": "在设置页编辑此主机全局指令（~/.dsh/AGENTS.md），适用于此主机上所有会话。",
			"features.recall.title": "对话历史回忆",
			"features.recall.desc": "让 AI 记得你们之间的一切——字面/模糊/语义三层检索全部历史会话，完全本地离线。",
			"features.vision-toolkit.title": "视觉工具箱",
			"features.vision-toolkit.desc": "更强大的视觉工具包，直接粘贴即可进行图片理解、UI 还原、长截图分析等视觉任务。",
			"features.odai-governance.title": "Odai 治理路由",
			"features.odai-governance.desc": "对 profile 中每个 Agent 预设生效的 Odai 治理与责任路由——对齐目标与事实，守住授权与风险边界，治理任务执行到真实验收。",
			"features.cost-meter.title": "会话成本统计",
			"features.cost-meter.desc": "会话/每日成本与预算、官方与自定义供应商余额、Coding Plan 配额、token 热力图与峰谷计价，内置 90+ 模型价格目录。",
			"features.dsh-pocket.title": "口袋访问",
			"features.dsh-pocket.desc": "把 DeepSeek Harness 装进你的口袋：电脑上跑 dsh web，手机扫码即同步访问（局域网 + 公网，实时同屏）。",
		};
		var en = {
			...
			"tab.discover": "Plugin Market",
			"tab.curated": "Curated",
			"discover.more": "Discover More",
			"curated.hint": "Community-curated plugin catalog (updated daily). Want to search every GitHub plugin? Switch to “Discover More”.",
			...
			"features.title": "Add-ons",
			"features.hint": "Optional features provided by Extension Hub — install to add settings pages.",
			"features.loading": "Loading…",
			"features.loadFailed": "Load failed: ",
			"features.install": "Install",
			"features.installing": "Installing…",
			"features.uninstall": "Uninstall",
			"features.disable": "Disable",
			"features.enable": "Enable",
			"features.statusInstalled": "Enabled",
			"features.statusDisabled": "Disabled",
			"features.statusMissing": "Not installed",
			"features.installDone": "Installed {name} — restart dsh web to apply.",
			"features.actionDone": "Written to config — restart dsh web to apply.",
			"features.opFailed": "Action failed: ",
			"features.disableConfirm": "Disable {name}? The feature will no longer take effect.",
			"features.uninstallWarn": "Uninstalling {name} removes it from the configuration and deletes its package files. Uninstalling a feature whose purpose you don't understand may cause serious problems!",
			"features.bundleUninstallHint": "{name} was installed via the official `dsh plugin add` (bundle) path — uninstall it with `dsh plugin --profile web remove {name}` instead of reinstalling or deleting it here.",
			"features.confirmUninstall": "Confirm uninstall?",
			"features.my-rules.title": "Customize · Global instructions",
			"features.my-rules.desc": "Edit host-wide global instructions from the settings page — applies to every session on this host.",
			"features.recall.title": "Conversation recall",
			"features.recall.desc": "AI never forgets what you told it — three-layer (literal/fuzzy/semantic) retrieval over all session history, fully local & offline.",
			"features.vision-toolkit.title": "Vision toolkit",
			"features.vision-toolkit.desc": "A more powerful vision toolkit: paste an image directly for image understanding, UI restoration, long-screenshot analysis, and more visual tasks.",
			"features.odai-governance.title": "Odai governance",
			"features.odai-governance.desc": "Profile-wide Odai governance and responsibility routing for every agent preset in a DeepSeek Harness profile.",
			"features.cost-meter.title": "Session cost meter",
			"features.cost-meter.desc": "Per-session/daily cost & budget, official & custom provider balance, Coding Plan quotas, token heatmap with peak/off-peak pricing, built-in 90+ model price catalog.",
			"features.dsh-pocket.title": "Pocket access",
			"features.dsh-pocket.desc": "DeepSeek Harness in your pocket — run dsh web on your PC and sync access from your phone by scanning a QR code (LAN + public network, real-time screen mirroring).",
		};
		...
		var REMOTE_METHODS = ["list", "getSkill", "createSkill", "updateSkill", "removeSkill", "toggleSkill", "getMcp", "upsertMcp", "removeMcp", "toggleMcp", "discover", "importItems", "projectInfo", "getState", "setState", "pickProjectFolder", "listDirectory", "createDirectory", "listPlugins", "listFeatures", "setPluginEnabled", "removePlugin", "discoverPlugins", "curatedPlugins", "installPlugin", "checkPluginUpdates", "updatePluginItem", "checkUpdates", "updatePlugin"];
						...
						return h("div", { key: m.scope + "/" + m.id, className: "skm-item" },
							h("div", { className: "skm-item-main" },
								h("div", { className: "skm-item-title" }, h("span", null, m.serverName || m.id), h(Badge, { t: t, scope: m.scope }),
									...
									m.readOnly ? h("span", { className: "skm-badge", title: m.location }, t("badge.home")) : null),
		...
		function PluginsTab(props) {
			...
			var featuresState = React.useState(null);
			var features = featuresState[0];
			var setFeatures = featuresState[1];
			var featBusyState = React.useState(false);
			var featBusy = featBusyState[0];
			var setFeatBusy = featBusyState[1];
			var featConfirmState = React.useState(null);
			var featConfirm = featConfirmState[0];
			var setFeatConfirm = featConfirmState[1];
			var featCollapsedState = React.useState(false);
			var featCollapsed = featCollapsedState[0];
			var setFeatCollapsed = featCollapsedState[1];
			var errorState = React.useState("");
			var error = errorState[0];
			var setError = errorState[1];
			...
			var loadFeatures = function () {
				call("listFeatures", {}).then(function (r) {
					if (r && Array.isArray(r.features)) setFeatures(r.features);
				}).catch(function () {});
			};
			var runFeatureAction = function (type, f) {
				if (type === "uninstall" && f.bundle) {
					// Official `dsh plugin add` installs are owned by pnpm; the
					// row lives in the bundle layer and must not be deleted from
					// the profile patch (that would duplicate-register it).
					setOpMsg({ kind: "err", text: t("features.bundleUninstallHint", { name: f.name }) });
					return;
				}
				setFeatBusy(true);
				setFeatConfirm(null);
				var req = type === "install"
					? call("installPlugin", { npm: f.name })
					: type === "uninstall"
						? call("removePlugin", { id: f.rowId })
						: call("setPluginEnabled", { id: f.rowId, enabled: type === "enable" });
				req.then(function (r) {
					if (r && r.ok === false) {
						setOpMsg({ kind: "err", text: (r.message || t("features.opFailed")) });
					} else if (r && r.ok === true) {
						setOpMsg({ kind: "ok", text: type === "install" ? t("features.installDone", { name: f.name }) : t("features.actionDone") });
						loadFeatures();
						reload();
					} else {
						setOpMsg({ kind: "err", text: t("features.opFailed") });
					}
				}).catch(function (e) {
					setOpMsg({ kind: "err", text: t("features.opFailed") + errText(e) });
				}).finally(function () { setFeatBusy(false); });
			};
			...
			React.useEffect(function () {
				...
				call("listFeatures", {}).then(function (r) {
					if (alive && r && Array.isArray(r.features)) setFeatures(r.features);
				}).catch(function () {});
				return function () { alive = false; };
			}, []);
			...
			return h("div", { style: { display: "flex", flexDirection: "column", gap: 10 } },
				...
				h("div", { style: { display: "flex", flexDirection: "column", gap: 6 } },
					h("div", { className: "skm-group-head" },
						h("span", { style: { display: "inline-flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0, cursor: "pointer" }, onClick: function () { setFeatCollapsed(!featCollapsed); } },
							h("span", { className: "skm-group-arrow" + (featCollapsed ? "" : " skm-open") }, "▶"),
							h("span", null, t("features.title")),
							h("span", { className: "skm-group-count" }, String(features ? features.length : 0))),
						h("span", { className: "skm-hint" }, t("features.hint"))),
					!featCollapsed
						? (features === null ? h("div", { className: "skm-hint" }, t("features.loading")) :
							h("div", { className: "skm-list" },
								features.map(function (f) {
									var ftitle = t("features." + f.id + ".title");
									var fdesc = t("features." + f.id + ".desc");
									return h("div", { key: f.id, className: "skm-plugin-row" },
										h("div", { className: "skm-row" },
											h("span", { className: "skm-plugin-name" }, ftitle),
											f.installed
												? h("span", { className: "skm-badge", style: f.enabled ? { color: "#12965b", background: "rgba(18,150,91,.1)" } : { color: "#8f959e", background: "rgba(0,0,0,.06)" } }, f.enabled ? t("features.statusInstalled") : t("features.statusDisabled"))
												: h("span", { className: "skm-badge" }, t("features.statusMissing"))),
										fdesc ? h("div", { className: "skm-item-desc" }, fdesc) : null,
										h("div", { className: "skm-row", style: { gap: 8, marginTop: 6 } },
											!f.installed
												? Btn({ sm: true, kind: "primary", disabled: featBusy, onClick: function () { runFeatureAction("install", f); } }, featBusy ? t("features.installing") : t("features.install"))
												: [
													f.enabled
														? Btn({ sm: true, disabled: featBusy, onClick: function () { setFeatConfirm({ type: "disable", f: f }); } }, t("features.disable"))
														: Btn({ sm: true, kind: "success", disabled: featBusy, onClick: function () { runFeatureAction("enable", f); } }, t("features.enable")),
													Btn({ sm: true, kind: "danger", disabled: featBusy, onClick: function () { setFeatConfirm({ type: "uninstall", f: f }); } }, t("features.uninstall")),
												]));
								})))
						: null),
				...
				featConfirm ? h(Modal, { title: featConfirm.type === "uninstall" ? t("plugins.confirmTitle") : t("features.disableConfirm", { name: t("features." + featConfirm.f.id + ".title") }), onClose: function () { setFeatConfirm(null); } },
					h("div", { style: { display: "flex", flexDirection: "column", gap: 12 } },
						featConfirm.type === "uninstall"
							? [
								h("div", null, t("features.uninstallWarn", { name: t("features." + featConfirm.f.id + ".title") })),
								h("div", { className: "skm-hint" }, t("features.confirmUninstall")),
							]
							: h("div", null, t("features.disableConfirm", { name: t("features." + featConfirm.f.id + ".title") })),
						h("div", { className: "skm-row", style: { justifyContent: "flex-end", gap: 8 } },
							Btn({ onClick: function () { setFeatConfirm(null); } }, t("cancel")),
							Btn({ kind: "danger", onClick: function () { runFeatureAction(featConfirm.type, featConfirm.f); } }, featConfirm.type === "uninstall" ? t("features.uninstall") : t("features.disable"))))) : null);
		}
		...
		function DiscoverTab(props) {
			...
			return h("div", { style: { display: "flex", flexDirection: "column", gap: 10 } },
				h("div", { className: "skm-row", style: { gap: 6 } },
					...
					h("button", { type: "button", className: "skm-tab" + (view === "search" ? " skm-active" : ""), onClick: function () { setView("search"); } }, t("discover.more"))),
			...
			var runInstall = function (repo) {
				...
				call("installPlugin", { repo: repo.fullName }).then(function (r) {
					...
					if (r && r.ok === false) {
						...
						else if (r.message) setMsg({ kind: "err", text: r.message });
						...
						setMsg({ kind: "ok", text: r.message || t("discover.installDone") });
			...
			var runInstall = function (x) {
				...
				call("installPlugin", input).then(function (r) {
					...
					if (r && r.ok === false) {
						...
						setMsg({ kind: "ok", text: r.message || t("curated.installDone") });
